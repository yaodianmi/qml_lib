// via: https://wiki.qt.io/QtQuick_ToolTip_Component
...
Item {
    ...
    Component.onCompleted: {
        ...
        var newObject = Qt.createQmlObject('import QtQuick 2.9; MouseArea {signal mouserHover(int x, int y); signal showChanged(bool flag); anchors.fill:parent; hoverEnabled: true; onPositionChanged: {mouserHover(mouseX, mouseY)} onEntered: {showChanged(true)} onExited:{showChanged(false)} onClicked:{parent.focus = true}}', itemParent, "mouseItem");
